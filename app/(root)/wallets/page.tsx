...
const Wallets = () => {
  ...
  return (
    <div className="min-h-screen bg-brand flex flex-col items-center py-6 px-3">
      <div className="flex items-center justify-center lg:justify-between h-[100px] w-full max-w-[900px] mb-10 lg:mb-4">
        <Image src="/Full-Logo.svg" alt="MyWall" width={200} height={180} />
        <Button
          className="hidden lg:flex bg-brand-primary p-6 font-bold rounded-full hover:bg-brand-secondary"
          onClick={handleClick}
        >
          Add wallet
        </Button>
      ...
      <div className="flex-1 flex flex-col w-full max-w-[900px] items-center gap-3">
        <div className="flex w-full p-4 bg-[#ffffff] rounded-full justify-between items-center mb-5">
          ...
          <Button className="bg-brand-primary px-8 font-bold rounded-full hover:bg-brand-secondary">
            Show
          </Button>
        </div>
        <Button
          className="bg-brand-primary px-8 font-bold rounded-full hover:bg-brand-secondary lg:hidden max-w-32 mb-5"
          onClick={handleClick}
        >
          Add wallet
        </Button>
